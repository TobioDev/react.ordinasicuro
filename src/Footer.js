...
const Footer = () => {
    return (
        <footer class="pa4 pa5-l black-70 bt b--black-10">
            <div class="mb4-l cf">
                <h1 class="fl w-100 pv0 f6 fw6 ttu tracked mb2">Ordina Sicuro</h1>
            </div>
            <section class="cf mb5">
                <div class="mb4 mb0-ns w-100 w-50-l fr">
                    <a class="black-70 f3 f2-ns fw6 tl link dim dib pv3 mt2 mb2 mb0-l" href="mailto:info@ordinasicuro.it" >
                ...
                <div class="mb4 mb0-ns fl w-100 w-50-l" >
                    ...
                    <input placeholder="il tuo indirizzo e-mail" class="mw-100 w-100 w5-ns f5 input-reset ba b--black-20 pv3 ph4 border-box"/>
                    <input type="submit" class="input-reset w-100 w-auto-ns bg-black-80 white f5 pv2 pv3-ns ph4 ba b--black-80 bg-hover-mid-gray" value="Iscriviti ora"/>
                </div>
            </section>
